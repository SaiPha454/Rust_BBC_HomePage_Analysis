//Generated:2023-08-24 05:11:56// 6-274
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4215879 || '',
    guid: window.ftGUID_4215879 || '',
    confID: window.ftConfID_4215879 || '0',
    ftReturn: window.ftReturn_4215879 || '',
    keyword: window.ftKeyword_4215879 || '',
    ftId: window.ftId_4215879 || '',
    ftImpId: window.ftImp4215879 && window.ftImp4215879.impID || '',
    gdpr: window.ftImp4215879 && window.ftImp4215879.gdpr || '',
    gdpr_consent: window.ftImp4215879 && window.ftImp4215879.gdpr_consent || '',
    gdpr_pd: window.ftImp4215879 && window.ftImp4215879.gdpr_pd || '',
    us_privacy: window.ftImp4215879 && window.ftImp4215879.us_privacy || '',
    campaignID: '115843',
    cID: '100966',
    pID: '4215879',
    creativeID: '3628378',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115843&sid=18330&plc=4215879&num=&adid=&advid=&adsrv=29&btreg=4215879&btadsrv=flashtalking&crt=3628378&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115843;4215879;3628378;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/th_th/creativecloud/plans.html?sdid=MH16SBLQ&mv=display&mv2=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?214607793-4215879;3628378;',
    centreAd: false,
    width: 300,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/421/4215879/3628378/image/3628378.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115843;4215879;202;pixel;DV360;DV360FY20CCRTRCCTOverallTHDSKBAN300x600/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115843;4215879;3628378;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/th_th/creativecloud/plans.html?sdid=MH16SBLQ&mv=display&mv2=display",
    divID: 'ftdiv4215879',
    altimgID: 'ftalt4215879',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4215879 && parseInt(window.ftImp4215879.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4215879') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4215879'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4215879").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4215879").style.display = "none";
		    }
		});
	}
}(ft4215879));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115843&l2=DV360&l3=4215879&l4=3628378&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115843&l2=DV360&l3=4215879&l4=3628378&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4215879;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4215879;
